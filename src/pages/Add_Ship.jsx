            ...
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8'>
                <div className='mb-4'>
                    ...
                    >
                        ...
                        <option value="add_stock_qty">Add Stock Quantity</option>
                    </select>
                </div>
                ...
                {action && (
                    <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${action === "Add"
                        ...
                        <span className={`w-2 h-2 rounded-full mr-2 ${action === "Add" ? 'bg-green-500' : 'bg-blue-500'
                            }`}></span>
                        {action === "Add" ? 'Adding Stock' : 'Shipping Stock'}
                    </div>
                )}
            </div>
